...
# Let's run a simple simulation for 2025 and record the daily generated features to see if it gets stuck!
...
for i, curr_date_np in enumerate(future_dates):
    ...
    feats_dict = {
        ...
        'NINO3_Anom': 0.0, 'NINO4_Anom': 0.0, 'NINO3.4_Anom': 0.0, 'NINO3.4_Anom_Lag1': 0.0, # neutral fallback
...
print("First 30 days of simulation:")
print(sim_df.head(30)[['Date', 'Prob_Rain', 'IsRainy', 'TempRange', 'TempRange_Roll3']])

print("\nWet spells duration counts:")
# count of consecutive rainy days
sim_df['Wet_Spell'] = (sim_df['IsRainy'] == 1).groupby((sim_df['IsRainy'] != 1).cumsum()).cumsum()
print(sim_df['Wet_Spell'].value_counts().head(20))
